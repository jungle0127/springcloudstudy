package com.ps.dtx.basictransaction.doubledb.jta.config;
...
@Configuration
@MapperScan(basePackages = "com.ps.dtx.basictransaction.doubledb.jta.dao.storage.mapper", sqlSessionTemplateRef = "storageSqlSessionTemplate")
